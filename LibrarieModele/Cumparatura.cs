...
namespace LibrarieModele
{
    public class Cumparatura
    {
        ...
        public Cumparatura()
        { }
        public Cumparatura(string Nume_utilizator, int idElectronic, string nume_produs, string firma, string model, string specificatii, string culoare, decimal pret, int nr_produse, decimal total, string modalitate_plata)
        {
        ...
        public Cumparatura(DataRow linieBD)
        {
